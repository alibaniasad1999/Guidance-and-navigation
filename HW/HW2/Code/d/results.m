...
title('');
axis tight;
[dir_state, ~, ~] = mkdir('../../Figure/d');
if dir_state
    print('../../Figure/d/missle_state','-depsc');
else
    fprintf("Ooooooops\n")
end
...
[dir_state, ~, ~] = mkdir('../../Figure/d');
if dir_state
    print('../../Figure/d/missle_attitude','-depsc');
else
    fprintf("Ooooooops\n")
end
...
[dir_state, ~, ~] = mkdir('../../Figure/d');
if dir_state
    print('../../Figure/d/target_state','-depsc');
else
    fprintf("Ooooooops\n")
end
...
[dir_state, ~, ~] = mkdir('../../Figure/d');
if dir_state
    print('../../Figure/d/target_attitude','-depsc');
else
    fprintf("Ooooooops\n")
end
...
[dir_state, ~, ~] = mkdir('../../Figure/d');
if dir_state
    print('../../Figure/d/missle_vs_target_state','-depsc');
else
    fprintf("Ooooooops\n")
end
close;
...
[dir_state, ~, ~] = mkdir('../../Figure/d');
if dir_state
    print('../../Figure/d/3DoF_missle_vs_target_state','-depsc');
else
    fprintf("Ooooooops\n")
end
close
...
[dir_state, ~, ~] = mkdir('../../Figure/d');
if dir_state
    print('../../Figure/d/miss_distance','-depsc');
else
    fprintf("Ooooooops\n")
end

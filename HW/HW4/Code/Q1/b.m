...
[dir_state, ~, ~] = mkdir('../../Figure/Q1/b');
if dir_state
    print('../../Figure/Q1/b/lat_vs_alt', '-depsc');
else
    fprintf("Ooooooops\n")
end
...
function dydt = missle(t,y) % y = [x, y, vx, vy]
    r = y(1:2); % position
    v = y(3:4); % velocity
    ...
    gamma = pi/2; % angle of the thrust vector
    thrust_vec = thrust_vector_calculator(Thrust, gamma, r); % thrust vector
    % drag %

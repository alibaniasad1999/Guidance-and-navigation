...
[dir_state, ~, ~] = mkdir('../../Figure/Q1/d');
if dir_state
    print('../../Figure/Q1/d/lat_vs_alt', '-depsc');
else
    fprintf("Ooooooops\n")
end
...
[dir_state, ~, ~] = mkdir('../../Figure/Q1/d');
if dir_state
    print('../../Figure/Q1/d/xy_earth', '-depsc');
else
    fprintf("Ooooooops\n")
end

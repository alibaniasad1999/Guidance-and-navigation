...
MODEL                := model
MODULES              := model_data.c model_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := model.mk
...
SLDRTDIR             := /Applications/MATLAB_R2023a.app/toolbox/sldrt
TARGETARCH           := maci64
CC_LISTING           := 0
REBUILD_ALL          := 0
